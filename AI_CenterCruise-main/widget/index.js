(function () {
  ...
  fab.innerHTML = `<svg viewBox="0 0 40 40"><path d="M5.33333 6H32C33.8333 6 35.3333 7.5 35.3333 9.33333V29.3333C35.3333 31.1667 33.8333 32.6667 32 32.6667H8.66667L2 39.3333V9.33333C2 7.5 3.5 6 5.33333 6Z"></path></svg>`;
  ...
  const closePanel = () => {
    ...
    setTimeout(() => panel.style.height = "390px", 300);
  };
